...
htmlhelp_basename = 'sbmlutilsdoc'
...
latex_documents = [
    (master_doc, 'sbmlutils.tex', u'sbmlutils Documentation',
     u'Matthias König', 'manual'),
]
...
man_pages = [
    (master_doc, 'sbmlutils', u'sbmlutils Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sbmlutils', u'sbmlutils Documentation',
     author, 'sbmlutils', 'One line description of project.',
     'Miscellaneous'),
]
