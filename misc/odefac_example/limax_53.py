...
yids = [
    ...
    "Qha",
    "RenalClearance_apap",
    "RenalClearance_co2c13",
    "RenalClearance_metc13",
    "import_gu_apap",
    "import_gu_co2c13",
    "import_gu_metc13",
    "import_he_apap",
...
def f_dxdt(x, t, p):
    ...
    FVre = 1 - (
        p[23] + p[22] + p[24] + p[25] + p[26] + p[27] + p[28] + p[21]
    )  # [6] FVre
    ...
    Var = p[5] * p[21] - (p[21] / (p[21] + p[28])) * p[5] * p[33] * (
        1 - p[28] - p[21]
    )  # [13] Var
    Vgu = p[5] * p[22]  # [14] Vgu
    Vhe = p[5] * p[23]  # [15] Vhe
    ...
    CYP1A2MET = (
        CYP1A2MET_CLliv * 1 * (Cli_metc13 / (Cli_metc13 + p[12]))
    )  # [107] CYP1A2MET
    ...
    Exhalation_co2c13 = (
        p[13] * 60 * Clu_co2c13 / (p[14] + Clu_co2c13)
    )  # [114] Exhalation_co2c13
    ...
    import_gu_apap = (
        p[53] * Vgu_tissue * (p[40] * Cgu_blood_apap - Cgu_apap)
    )  # [155] import_gu_apap
    import_gu_co2c13 = (
        p[54] * Vgu_tissue * (p[41] * Cgu_blood_co2c13 - Cgu_co2c13)
    )  # [156] import_gu_co2c13
    import_gu_metc13 = (
        p[55] * Vgu_tissue * (p[42] * Cgu_blood_metc13 - Cgu_metc13)
    )  # [157] import_gu_metc13
    import_he_apap = (
        p[53] * Vhe_tissue * (p[40] * Che_blood_apap - Che_apap)
    )  # [158] import_he_apap
    import_he_co2c13 = (
        p[54] * Vhe_tissue * (p[41] * Che_blood_co2c13 - Che_co2c13)
    )  # [159] import_he_co2c13
    import_he_metc13 = (
        p[55] * Vhe_tissue * (p[42] * Che_blood_metc13 - Che_metc13)
    )  # [160] import_he_metc13
    import_ki_apap = (
        p[53] * Vki_tissue * (p[40] * Cki_blood_apap - Cki_apap)
    )  # [161] import_ki_apap
    import_ki_co2c13 = (
        p[54] * Vki_tissue * (p[41] * Cki_blood_co2c13 - Cki_co2c13)
    )  # [162] import_ki_co2c13
    import_ki_metc13 = (
        p[55] * Vki_tissue * (p[42] * Cki_blood_metc13 - Cki_metc13)
    )  # [163] import_ki_metc13
    import_li_apap = (
        p[53] * Vli_tissue * (p[40] * Cli_blood_apap - Cli_apap)
    )  # [164] import_li_apap
    import_li_co2c13 = (
        p[54] * Vli_tissue * (p[41] * Cli_blood_co2c13 - Cli_co2c13)
    )  # [165] import_li_co2c13
    import_li_metc13 = (
        p[55] * Vli_tissue * (p[42] * Cli_blood_metc13 - Cli_metc13)
    )  # [166] import_li_metc13
    import_lu_apap = (
        p[53] * Vlu_tissue * (p[40] * Clu_blood_apap - Clu_apap)
    )  # [167] import_lu_apap
    import_lu_co2c13 = (
        p[54] * Vlu_tissue * (p[41] * Clu_blood_co2c13 - Clu_co2c13)
    )  # [168] import_lu_co2c13
    import_lu_metc13 = (
        p[55] * Vlu_tissue * (p[42] * Clu_blood_metc13 - Clu_metc13)
    )  # [169] import_lu_metc13
    import_sp_apap = (
        p[53] * Vsp_tissue * (p[40] * Csp_blood_apap - Csp_apap)
    )  # [170] import_sp_apap
    import_sp_co2c13 = (
        p[54] * Vsp_tissue * (p[41] * Csp_blood_co2c13 - Csp_co2c13)
    )  # [171] import_sp_co2c13
    import_sp_metc13 = (
        p[55] * Vsp_tissue * (p[42] * Csp_blood_metc13 - Csp_metc13)
    )  # [172] import_sp_metc13
    ...
    import_re_apap = (
        p[53] * Vre_tissue * (p[40] * Cre_blood_apap - Cre_apap)
    )  # [180] import_re_apap
    import_re_co2c13 = (
        p[54] * Vre_tissue * (p[41] * Cre_blood_co2c13 - Cre_co2c13)
    )  # [181] import_re_co2c13
    import_re_metc13 = (
    ...
    # ode
    return [
        (-Flow_ar_gu_apap - Flow_ar_he_apap - Flow_ar_ki_apap - Flow_ar_li_apap)
        + Flow_lu_ar_apap
        - Flow_ar_sp_apap
        - Flow_ar_re_apap,  # [0] Aar_apap
        (-Flow_ar_gu_co2c13 - Flow_ar_he_co2c13 - Flow_ar_ki_co2c13 - Flow_ar_li_co2c13)
        + Flow_lu_ar_co2c13
        - Flow_ar_sp_co2c13
        - Flow_ar_re_co2c13,  # [1] Aar_co2c13
        (-Flow_ar_gu_metc13 - Flow_ar_he_metc13 - Flow_ar_ki_metc13 - Flow_ar_li_metc13)
        + Flow_lu_ar_metc13
        - Flow_ar_sp_metc13
        - Flow_ar_re_metc13,  # [2] Aar_metc13
        Exhalation_co2c13,  # [3] Abreath_co2c13
        import_gu_apap,  # [4] Agu_apap
        (Absorption_apap - import_gu_apap)
        + Flow_ar_gu_apap
        - Flow_gu_li_apap,  # [5] Agu_blood_apap
        (Absorption_co2c13 - import_gu_co2c13)
        + Flow_ar_gu_co2c13
        - Flow_gu_li_co2c13,  # [6] Agu_blood_co2c13
        (Absorption_metc13 - import_gu_metc13)
        + Flow_ar_gu_metc13
        - Flow_gu_li_metc13,  # [7] Agu_blood_metc13
        ...
        -import_he_co2c13
        + Flow_ar_he_co2c13
        - Flow_he_ve_co2c13,  # [12] Ahe_blood_co2c13
        -import_he_metc13
        + Flow_ar_he_metc13
        - Flow_he_ve_metc13,  # [13] Ahe_blood_metc13
        ...
        -import_ki_co2c13
        + Flow_ar_ki_co2c13
        - Flow_ki_ve_co2c13,  # [18] Aki_blood_co2c13
        -import_ki_metc13
        + Flow_ar_ki_metc13
        - Flow_ki_ve_metc13,  # [19] Aki_blood_metc13
        ...
        ((Flow_gu_li_apap - import_li_apap) + Flow_ar_li_apap - Flow_li_ve_apap)
        + Flow_sp_li_apap,  # [23] Ali_blood_apap
        ((Flow_gu_li_co2c13 - import_li_co2c13) + Flow_ar_li_co2c13 - Flow_li_ve_co2c13)
        + Flow_sp_li_co2c13,  # [24] Ali_blood_co2c13
        ((Flow_gu_li_metc13 - import_li_metc13) + Flow_ar_li_metc13 - Flow_li_ve_metc13)
        + Flow_sp_li_metc13,  # [25] Ali_blood_metc13
        ...
        -import_lu_co2c13
        + Flow_ve_lu_co2c13
        - Flow_lu_ar_co2c13,  # [30] Alu_blood_co2c13
        -import_lu_metc13
        + Flow_ve_lu_metc13
        - Flow_lu_ar_metc13,  # [31] Alu_blood_metc13
        ...
        -import_re_co2c13
        + Flow_ar_re_co2c13
        - Flow_re_ve_co2c13,  # [36] Are_blood_co2c13
        -import_re_metc13
        + Flow_ar_re_metc13
        - Flow_re_ve_metc13,  # [37] Are_blood_metc13
        ...
        -import_sp_co2c13
        + Flow_ar_sp_co2c13
        - Flow_sp_li_co2c13,  # [42] Asp_blood_co2c13
        -import_sp_metc13
        + Flow_ar_sp_metc13
        - Flow_sp_li_metc13,  # [43] Asp_blood_metc13
        ...
        + Flow_re_ve_co2c13,  # [50] Ave_co2c13
        (
            Injection_metc13
            + Infusion_metc13
            + Flow_he_ve_metc13
        ...
        + Flow_re_ve_metc13,  # [51] Ave_metc13
