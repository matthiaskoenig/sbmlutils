    ...
    <table class="table table-borderless table-sm table-condensed compact">
        <tbody>
            <tr v-if="info.substanceUnits != null">
                ...
                <td>
                    <span v-if="info.substanceUnits != null">
                        <katex :mathStr="info.substanceUnits" />
                    </span>
                </td>
            </tr>
            <tr v-if="info.timeUnits != null">
