...
y_dmod <- c(
    ...
    P_CO2c13 = "(R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60",   # [158]
    Qha = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp",   # [159]
    ar_bo_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Aar_apap / (BW * FVar))",   # [160]
    ar_bo_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Aar_co2c13 / (BW * FVar))",   # [161]
    ar_bo_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Aar_metc13 / (BW * FVar))",   # [162]
    ar_gu_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Aar_apap / (BW * FVar))",   # [163]
    ar_gu_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Aar_co2c13 / (BW * FVar))",   # [164]
    ar_gu_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Aar_metc13 / (BW * FVar))",   # [165]
    ar_he_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Aar_apap / (BW * FVar))",   # [166]
    ar_he_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Aar_co2c13 / (BW * FVar))",   # [167]
    ar_he_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Aar_metc13 / (BW * FVar))",   # [168]
    ar_ki_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aar_apap / (BW * FVar))",   # [169]
    ar_ki_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aar_co2c13 / (BW * FVar))",   # [170]
    ar_ki_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aar_metc13 / (BW * FVar))",   # [171]
    ar_re_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Aar_apap / (BW * FVar))",   # [172]
    ar_re_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Aar_co2c13 / (BW * FVar))",   # [173]
    ar_re_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Aar_metc13 / (BW * FVar))",   # [174]
    ar_sp_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Aar_apap / (BW * FVar))",   # [175]
    ar_sp_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Aar_co2c13 / (BW * FVar))",   # [176]
    ar_sp_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Aar_metc13 / (BW * FVar))",   # [177]
    bo_ve_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Abo_apap / (BW * FVbo) / Kpbo_apap) * BP_apap",   # [178]
    bo_ve_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Abo_co2c13 / (BW * FVbo) / Kpbo_co2c13) * BP_co2c13",   # [179]
    bo_ve_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQbo * (Abo_metc13 / (BW * FVbo) / Kpbo_metc13) * BP_metc13",   # [180]
    gu_li_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Agu_apap / (BW * FVgu) / Kpgu_apap) * BP_apap",   # [181]
    gu_li_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Agu_co2c13 / (BW * FVgu) / Kpgu_co2c13) * BP_co2c13",   # [182]
    gu_li_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu * (Agu_metc13 / (BW * FVgu) / Kpgu_metc13) * BP_metc13",   # [183]
    he_ve_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Ahe_apap / (BW * FVhe) / Kphe_apap) * BP_apap",   # [184]
    he_ve_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Ahe_co2c13 / (BW * FVhe) / Kphe_co2c13) * BP_co2c13",   # [185]
    he_ve_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQhe * (Ahe_metc13 / (BW * FVhe) / Kphe_metc13) * BP_metc13",   # [186]
    ki_ve_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aki_apap / (BW * FVki) / Kpki_apap) * BP_apap",   # [187]
    ki_ve_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aki_co2c13 / (BW * FVki) / Kpki_co2c13) * BP_co2c13",   # [188]
    ki_ve_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQki * (Aki_metc13 / (BW * FVki) / Kpki_metc13) * BP_metc13",   # [189]
    li_ve_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh * (Ali_apap / (BW * FVli) / Kpli_apap) * BP_apap",   # [190]
    li_ve_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh * (Ali_co2c13 / (BW * FVli) / Kpli_co2c13) * BP_co2c13",   # [191]
    li_ve_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh * (Ali_metc13 / (BW * FVli) / Kpli_metc13) * BP_metc13",   # [192]
    lu_ar_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Alu_apap / (BW * FVlu) / Kplu_apap) * BP_apap",   # [193]
    lu_ar_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Alu_co2c13 / (BW * FVlu) / Kplu_co2c13) * BP_co2c13",   # [194]
    lu_ar_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Alu_metc13 / (BW * FVlu) / Kplu_metc13) * BP_metc13",   # [195]
    re_ve_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Are_apap / (BW * (1 - (FVbo + FVhe + FVgu + FVki + FVli + FVlu + FVsp + FVve + FVar + FVpl))) / Kpre_apap) * BP_apap",   # [196]
    re_ve_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Are_co2c13 / (BW * (1 - (FVbo + FVhe + FVgu + FVki + FVli + FVlu + FVsp + FVve + FVar + FVpl))) / Kpre_co2c13) * BP_co2c13",   # [197]
    re_ve_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * (1 - (FQbo + FQhe + FQgu + FQki + FQh + FQsp)) * (Are_metc13 / (BW * (1 - (FVbo + FVhe + FVgu + FVki + FVli + FVlu + FVsp + FVve + FVar + FVpl))) / Kpre_metc13) * BP_metc13",   # [198]
    sp_li_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Asp_apap / (BW * FVsp) / Kpsp_apap) * BP_apap",   # [199]
    sp_li_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Asp_co2c13 / (BW * FVsp) / Kpsp_co2c13) * BP_co2c13",   # [200]
    sp_li_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp * (Asp_metc13 / (BW * FVsp) / Kpsp_metc13) * BP_metc13",   # [201]
    ve_lu_apap = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Ave_apap / (BW * FVve))",   # [202]
    ve_lu_co2c13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Ave_co2c13 / (BW * FVve))",   # [203]
    ve_lu_metc13 = "((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQlu * (Ave_metc13 / (BW * FVve))",   # [204]
    vre_apap = "CLrenal_apap * ((Aki_apap / (BW * FVki)) * fup_apap)",   # [205]
    vre_co2c13 = "CLrenal_co2c13 * ((Aki_co2c13 / (BW * FVki)) * fup_co2c13)",   # [206]
    vre_metc13 = "CLrenal_metc13 * ((Aki_metc13 / (BW * FVki)) * fup_metc13)",   # [207]
    ...
    P_CO2Fc13 = "((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60) / ((1 / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + ((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60))",   # [209]
    P_CO2R = "((R_PDB / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60) + KLU_EXCO2 * 60 * (Alu_co2c13 / (BW * FVlu)) * (BW * FVlu) / 60) / ((1 / (1 + R_PDB)) * (0.024265 * (BW / 1)**0.5378 * (HEIGHT / 1)**0.3964 * P_CO2BSA / 60))",   # [210]
    ar_li_apap = "(((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp) * (Aar_apap / (BW * FVar))",   # [211]
    ar_li_co2c13 = "(((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp) * (Aar_co2c13 / (BW * FVar))",   # [212]
    ar_li_metc13 = "(((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQh - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQgu - ((BW * COBW + (HR - HRrest) * COHRI / 60) / 1000) * 3600 * FQsp) * (Aar_metc13 / (BW * FVar))"  # [213]
)
