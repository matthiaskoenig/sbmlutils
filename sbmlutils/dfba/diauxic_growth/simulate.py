...
def simulate_diauxic_growth(sbml_top_path, tend, dt):
    """ Simulate the diauxic growth model.
    ...
    analyse.print_species(os.path.join(directory, "dg_species.png"), sim.solution, **plot_kwargs)
    analyse.print_fluxes(os.path.join(directory, "dg_fluxes.png"), sim.solution, **plot_kwargs)
    return df
...
if __name__ == "__main__":
    ...
    simulate_diauxic_growth(sbml_top_path, tend=20, dt=0.1)
