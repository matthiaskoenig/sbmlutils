...
G6PASE = ReactionTemplate(
    ...
    pars=[
        ...
        mc.Parameter('G6PASE_Vmax', 18.9, 'mmole_per_min'),
    ],
...
GPI = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('GPI_Vmax', 420, 'mmole_per_min'),
    ],
...
G16PI = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('G16PI_Vmax', 100, 'mmole_per_min'),
    ],
...
UPGASE = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('UPGASE_Vmax', 80, 'mmole_per_min'),
    ],
...
PPASE = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PPASE_Vmax', 2.4, 'mmole_per_min'),
    ],
...
GS = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('GS_Vmax', 13.2, 'mmole_per_min'),
    ],
    rules=[
       ...
       mc.AssignmentRule('GSn', 'f_glyglc * GS_Vmax * GS_fs * udpglc / (GSn_k_udpglc + udpglc)', 'mmole_per_min'),
       mc.AssignmentRule('GSp', 'f_glyglc * GS_Vmax * GS_fs * udpglc / (GSp_k_udpglc + udpglc)', 'mmole_per_min'),
    ],
...
GP = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('GP_Vmax', 6.8, 'mmole_per_min'),
    ],
    rules=[
...
NDKGTP = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('NDKGTP_Vmax', 0, 'mmole_per_min'),
    ],
    rules=[],
...
NDKUTP = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('NDKUTP_Vmax', 2940, 'mmole_per_min'),
    ],
    rules=[],
...
AK = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('AK_Vmax', 0, 'mmole_per_min'),
    ],
    rules=[],
...
PFK2 = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PFK2_Vmax', 0.0042, 'mmole_per_min'),
    ],
    rules=[
...
FBP2 = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('FBP2_Vmax', 0.126, 'mmole_per_min'),
    ],
    rules=[
...
PFK1 = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PFK1_Vmax', 7.182, 'mmole_per_min'),
    ],
...
FBP1 = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('FBP1_Vmax', 4.326, 'mmole_per_min'),
    ],
...
ALD = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('ALD_Vmax', 420, 'mmole_per_min'),
    ],
...
TPI = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('TPI_Vmax', 420, 'mmole_per_min'),
    ],
...
GAPDH = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('GAPDH_Vmax', 420, 'mmole_per_min'),
    ],
...
PGK = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PGK_Vmax', 420, 'mmole_per_min'),
    ],
...
PGM = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PGM_Vmax', 420, 'mmole_per_min'),
    ],
...
EN = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('EN_Vmax', 35.994, 'mmole_per_min'),
    ],
...
PK = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PK_Vmax', 46.2, 'mmole_per_min'),
    ],
    rules=[
...
PEPCK = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PEPCK_Vmax', 0, 'mmole_per_min'),
    ],
...
PEPCKM = ReactionTemplate(
    ...
    compartment='mito',
    pars=[
       mc.Parameter('PEPCKM_Vmax', 546, 'mmole_per_min'),
    ],
...
PC = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PC_Vmax', 168, 'mmole_per_min'),
    ],
...
LDH = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('LDH_Vmax', 12.6, 'mmole_per_min'),
    ],
...
LACT = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('LACT_Vmax', 5.418, 'mmole_per_min'),
    ],
...
PYRTM = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PYRTM_Vmax', 42, 'mmole_per_min'),
    ],
...
PEPTM = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PEPTM_Vmax', 33.6, 'mmole_per_min'),
    ],
...
PDH = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('PDH_Vmax', 13.44, 'mmole_per_min'),
    ],
    rules=[
       mc.AssignmentRule('PDH_base', 'f_gly * PDH_Vmax * pyr_mito/(pyr_mito + PDH_k_pyr) * '
                         ...
                         'mmole_per_min'),
       mc.AssignmentRule('PDHn', 'PDH_base * PDHn_alpha', 'mmole_per_min'),
       mc.AssignmentRule('PDHp', 'PDH_base * PDHp_alpha', 'mmole_per_min'),
    ],
...
CS = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('CS_Vmax', 4.2, 'mmole_per_min'),
    ],
...
NDKGTPM = ReactionTemplate(
    ...
    pars=[
       ...
       mc.Parameter('NDKGTPM_Vmax', 420, 'mmole_per_min'),
    ],
...
OAAFLX = ReactionTemplate(
    ...
    compartment='mito',
    pars=[
       mc.Parameter('OAAFLX_Vmax', 0, 'mmole_per_min'),
    ],
...
ACOAFLX = ReactionTemplate(
    ...
    compartment='mito',
    pars=[
       mc.Parameter('ACOAFLX_Vmax', 0, 'mmole_per_min'),
    ],
...
CITFLX = ReactionTemplate(
    ...
    compartment='mito',
    pars=[
       mc.Parameter('CITFLX_Vmax', 0, 'mmole_per_min'),
    ],
