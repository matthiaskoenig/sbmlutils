...
from sbmlutils.examples.models.acetaminophen.model_liver import create_model as create_liver_model
from sbmlutils.examples.models.acetaminophen.model_kidney import create_model as create_kidney_model
from sbmlutils.examples.models.acetaminophen.model_body import create_model as create_body_model
...
if __name__ == "__main__":
    ...
    sbml_path_flat = "./models/acetaminophen_body_flat.xml"
    import libsbml
