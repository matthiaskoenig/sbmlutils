...
species = [
    Species("apap_ext", initialConcentration=0.2, name="paracetamol (extern)",
...
reactions = [
    ...
    Reaction("APAPIM",
             ...
             pars=[
                 Parameter("APAP_Vmax", 0.05, unit=UNIT_mmole_per_min),
                 Parameter("Import_Km", 0.05, unit=UNIT_mM),
             ],
             formula=("APAP_Vmax* (apap_ext/Vli)/(apap_ext/Vli+Import_Km) ", UNIT_mmole_per_min)),
    # Biochemistry
    Reaction("APAPGLU",
             equation="apap -> apapglu",
             sboTerm=SBO_BIOCHEMICAL_REACTION,
             pars=[
                 Parameter("APAPGLU_Vmax", 1e-4, unit=UNIT_mmole_per_min),
    ...
    Reaction("APAPSUL",
             ...
             sboTerm=SBO_BIOCHEMICAL_REACTION,
             pars=[
                 Parameter("APAPSUL_Vmax", 5e-5, unit=UNIT_mmole_per_min),
    ...
    Reaction("APAPGSH",
             ...
             sboTerm=SBO_BIOCHEMICAL_REACTION,
             pars=[
                 Parameter("APAPGSH_Vmax", 1e-6, unit=UNIT_mmole_per_min),
    ...
    Reaction("APAPMER",
             ...
             sboTerm=SBO_BIOCHEMICAL_REACTION,
             pars=[
                 Parameter("APAPMER_Vmax", 1e-6, unit=UNIT_mmole_per_min),
    ...
    Reaction("APAPGLUEXP",
             ...
             sboTerm=SBO_TRANSPORT_REACTION,
             pars=[
                 Parameter("APAPGLUEXP_Vmax", 0.01, unit=UNIT_mmole_per_min),
                 Parameter("APAPGLUEXP_Km", 0.05, unit=UNIT_mM),
             ],
    ...
    Reaction("APAPSULEXP",
             ...
             sboTerm=SBO_TRANSPORT_REACTION,
             pars=[
                 Parameter("APAPSULEXP_Vmax", 0.01, unit=UNIT_mmole_per_min),
                 Parameter("APAPSULEXP_Km", 0.05, unit=UNIT_mM),
             ],
    ...
    Reaction("APAPCYSEXP",
             ...
             sboTerm=SBO_TRANSPORT_REACTION,
             pars=[
                 Parameter("APAPCYSEXP_Vmax", 0.01, unit=UNIT_mmole_per_min),
                 Parameter("APAPCYSEXP_Km", 0.05, unit=UNIT_mM),
             ],
    ...
    Reaction("APAPGSHEXP",
             ...
             sboTerm=SBO_TRANSPORT_REACTION,
             pars=[
                 Parameter("APAPGSHEXP_Vmax", 0.01, unit=UNIT_mmole_per_min),
                 Parameter("APAPGSHEXP_Km", 0.05, unit=UNIT_mM),
             ],
    ...
    Reaction("APAPMEREXP",
             ...
             sboTerm=SBO_TRANSPORT_REACTION,
             pars=[
                 Parameter("APAPMEREXP_Vmax", 0.01, unit=UNIT_mmole_per_min),
                 Parameter("APAPMEREXP_Km", 0.05, unit=UNIT_mM),
             ],
