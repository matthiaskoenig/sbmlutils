...
##############################################################
species.extend([
    fac.Species(sid='e__gal', compartment='ext', initialConcentration=3.0, substanceUnit='mM', boundaryCondition=True, name='D-galactose'),
    fac.Species(sid='c__gal', compartment='cyto', initialConcentration=0.00012, substanceUnit='mM', boundaryCondition=False,
                name='D-galactose'),
])
