...
# -----------------------------------------------------------------------------
compartments = [
    Compartment(sid='bioreactor', value=1.0, unit=UNIT_VOLUME, constant=True,
...
# -----------------------------------------------------------------------------
species = [
    Species(sid='Glcxt', name="glucose", initialConcentration=0.0,
            substanceUnit=UNIT_AMOUNT, hasOnlySubstanceUnits=False,
            compartment="bioreactor"),
    Species(sid='Ac', name="acetate", initialConcentration=0.0,
            substanceUnit=UNIT_AMOUNT, hasOnlySubstanceUnits=False,
            compartment="bioreactor"),
    Species(sid='O2', name="oxygen", initialConcentration=0.0,
            substanceUnit=UNIT_AMOUNT, hasOnlySubstanceUnits=False,
            compartment="bioreactor"),
    Species(sid='X', name="biomass", initialConcentration=0.0,
            substanceUnit=UNIT_AMOUNT, hasOnlySubstanceUnits=False,
            compartment="bioreactor"),
]
# -----------------------------------------------------------------------------
...
parameters = [
    # bounds
    Parameter(sid=FLUX_BOUND_ZERO, name="zero bound", value=0.0, unit=UNIT_FLUX,
              constant=True, sboTerm=SBO_FLUX_BOUND),
    Parameter(sid=FLUX_BOUND_PLUS_INF, name="default upper bound",
              value=float("Inf"), unit=UNIT_FLUX,
              constant=True, sboTerm=SBO_FLUX_BOUND),
    Parameter(sid=FLUX_BOUND_MINUS_INF, name="default lower bound",
              value=-float("Inf"), unit=UNIT_FLUX,
              constant=True, sboTerm=SBO_FLUX_BOUND),
    Parameter(sid=FLUX_BOUND_GLC_IMPORT, name="glc import bound",
              value=-15, unit=UNIT_FLUX,
              constant=True, sboTerm=SBO_FLUX_BOUND),
    Parameter(sid=FLUX_BOUND_O2_IMPORT, name="o2 import bound",
...
# exchange reactions
reactions.extend([
    ExchangeReaction(species_id="Ac",
