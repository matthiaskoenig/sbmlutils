...
compartments = [
    ...
    Compartment("Vki", 1.5, name="kidney", sboTerm=SBO_PHYSICAL_COMPARTMENT,
                unit=UNIT_KIND_LITRE, port=True),
...
reactions = [
    ...
    Reaction("MID1OHIM",
             ...
             pars=[
                 Parameter("MID1OHIM_Vmax", 5E-3, unit=UNIT_mmole_per_min),
                 Parameter("MID1OHIM_Km", 8.5E-3, unit=UNIT_mM)
                 ],
