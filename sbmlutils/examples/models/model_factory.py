...
import os
import sbmlutils.modelcreator as mc
...
def create_AssignmentTest():
    ...
    name = 'AssignmentTest'
    return mc.create_model(target_dir=os.path.join(models_dir, name, 'results'),
...
def create_demo():
    ...
    mc.create_model(target_dir, model_info, f_annotations=None, suffix='_no_annotations')
    return mc.create_model(target_dir, model_info, f_annotations)
