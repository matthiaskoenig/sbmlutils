...
if __name__ == "__main__":
    ...
    r.selections = ["time"] + r.model.getGlobalParameterIds() + r.model.getFloatingSpeciesIds() + [f"[{key}]" for key in r.model.getFloatingSpeciesIds()]
    ...
    r2.selections = ["time"] + r2.model.getGlobalParameterIds() + r2.model.getFloatingSpeciesIds() + [f"[{key}]" for key in r2.model.getFloatingSpeciesIds()]
    r2["D"] = 10  # ! InitialAssignment must be recalculated according to SBML specification !
