from libsbml import (UNIT_KIND_AMPERE, UNIT_KIND_AVOGADRO, UNIT_KIND_BECQUEREL,
                     UNIT_KIND_CANDELA, UNIT_KIND_CELSIUS, UNIT_KIND_COULOMB,
                     UNIT_KIND_DIMENSIONLESS, UNIT_KIND_FARAD, UNIT_KIND_GRAM,
                     UNIT_KIND_GRAY, UNIT_KIND_HERTZ, UNIT_KIND_ITEM, UNIT_KIND_KELVIN,
                     UNIT_KIND_KILOGRAM, UNIT_KIND_LITRE, UNIT_KIND_METER,
                     UNIT_KIND_METRE, UNIT_KIND_MOLE, UNIT_KIND_NEWTON, UNIT_KIND_OHM,
                     UNIT_KIND_SECOND, UNIT_KIND_VOLT)
...
UNIT_litre_per_mmole = Unit(
    'litre_per_mmole',
    [(UNIT_KIND_LITRE, 1.0, 0, 1), (UNIT_KIND_MOLE, -1, -3, 1)], port=True
)
