...
#: the normalizations of ruling R5, the only differences which are no difference
WHITELIST: tuple[Normalization, ...] = (
    ...
    Normalization(
        ...
        reason=(
            ...
            "the same registry, see rulings C1a and C1c"
        ),
